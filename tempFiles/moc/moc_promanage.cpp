...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProManage_t, stringdata) + ofs \
...
void ProManage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ProManage *_t = static_cast<ProManage *>(_o);
        switch (_id) {
...
const QMetaObject ProManage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProManage.data,
      qt_meta_data_ProManage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProManage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProManage.stringdata))
        return static_cast<void*>(const_cast< ProManage*>(this));
