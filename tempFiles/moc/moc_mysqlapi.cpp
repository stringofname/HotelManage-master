...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MysqlApi_t, stringdata) + ofs \
...
void MysqlApi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MysqlApi *_t = static_cast<MysqlApi *>(_o);
        switch (_id) {
...
const QMetaObject MysqlApi::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MysqlApi.data,
      qt_meta_data_MysqlApi,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MysqlApi::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MysqlApi.stringdata))
        return static_cast<void*>(const_cast< MysqlApi*>(this));
