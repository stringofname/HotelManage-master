...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModiftRoomPrice_t, stringdata) + ofs \
...
void ModiftRoomPrice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ModiftRoomPrice *_t = static_cast<ModiftRoomPrice *>(_o);
        switch (_id) {
...
const QMetaObject ModiftRoomPrice::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ModiftRoomPrice.data,
      qt_meta_data_ModiftRoomPrice,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ModiftRoomPrice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModiftRoomPrice.stringdata))
        return static_cast<void*>(const_cast< ModiftRoomPrice*>(this));
