...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BackupDatanaseDialog_t, stringdata) + ofs \
...
void BackupDatanaseDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BackupDatanaseDialog *_t = static_cast<BackupDatanaseDialog *>(_o);
        switch (_id) {
...
const QMetaObject BackupDatanaseDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BackupDatanaseDialog.data,
      qt_meta_data_BackupDatanaseDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BackupDatanaseDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BackupDatanaseDialog.stringdata))
        return static_cast<void*>(const_cast< BackupDatanaseDialog*>(this));
